...
function impact_map_languages() : array {
    $locale_name_array = [
        'en' => 'English',
        'en_US' => 'English',
        'amh' => 'Amharic',
        'ar' => 'Arabic',
        'ar_JO' => 'Arabic (Jordanian)',
        'ar_TN' => 'Arabic (Tunisian)',
        'ar_MA' => 'Arabic (Moroccan)',
        'hy' => 'Armenian',
        'az' => 'Azerbaijani',
