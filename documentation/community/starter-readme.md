![Build Status](https://github.com/DiscipleTools/gospel-ambition-impact-map/actions/workflows/ci.yml/badge.svg?branch=master)

# Disciple.Tools - Gospel Ambition Impact Map
...
#### Framework
 ...
 1. Disciple.Tools Theme presence check. ```ga_impact_map()```
...
[Issues](https://github.com/DiscipleTools/gospel-ambition-impact-map/issues) section of the repo. You can present ideas
in the [Discussions](https://github.com/DiscipleTools/gospel-ambition-impact-map/discussions) section of the repo. And
code contributions are welcome using the [Pull Request](https://github.com/DiscipleTools/gospel-ambition-impact-map/pulls)
system for git. For a more details on contribution see the
[contribution guidelines](https://github.com/DiscipleTools/gospel-ambition-impact-map/blob/master/CONTRIBUTING.md).
